...
\TitelDerArbeit{Muli Agent Dev}
\AutorDerArbeit{Benedikt Prisett, David Schäfer,\\[1.5mm] \>Eric Echtermeyer, Lasse Friedrich}
%\Abteilung{<Ihre Abteilung>}
%\Firma{<Ihre Firma>}
\Kurs{WWI-21-DSA}
\Studienrichtung{Data Science}
\Matrikelnummer{5709658, 7086451, 6373947, 9924680}
\Studiengangsleiter{Prof. Dr.-Ing. habil. Dennis Pfisterer}
\WissBetreuer{Clemens Biehl}
%\FirmenBetreuer{<Ihr(e) Firmenbetreuer(in)>}
\Bearbeitungszeitraum{26.11.2023 -- ??.01.2024}
